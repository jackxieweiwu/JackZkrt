...
public class JackSpinner extends TextView {
    private OnNothingSelectedListener onNothingSelectedListener;
    private OnItemSelectedListener onItemSelectedListener;
    private JackSpinnerBaseAdapter adapter;
    ...
    public JackSpinner(Context context) {
        super(context);
        init(context, null);
    }

    public JackSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public JackSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            @Override public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (onItemSelectedListener != null) {
                    ...
                    onItemSelectedListener.onItemSelected(JackSpinner.this, position, id, item);
                }
            }
        });
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            @Override public void onDismiss() {
                if (nothingSelected && onNothingSelectedListener != null) {
                    onNothingSelectedListener.onNothingSelected(JackSpinner.this);
                }
                if (!hideArrow) {
                    animateArrow(false);
                }
    ...
    public <T> void setItems(@NonNull List<T> items) {
        ...
        adapter = new JackSpinnerAdapter<>(getContext(), items).setTextColor(textColor);
    ...
    public void setAdapter(@NonNull ListAdapter adapter) {
        this.adapter = new JackSpinnerAdapterWrapper(getContext(), adapter);
        setAdapterInternal(this.adapter);
    }

    public <T> void setAdapter(JackSpinnerAdapter<T> adapter) {
        this.adapter = adapter;
        setAdapterInternal(adapter);
    }

    private void setAdapterInternal(@NonNull JackSpinnerBaseAdapter adapter) {
    ...
    public interface OnItemSelectedListener<T> {
         ...
         *     The selected item
         */
        void onItemSelected(JackSpinner view, int position, long id, T item);
    ...
    public interface OnNothingSelectedListener {
         ...
         *
         * @param spinner
         *     the {@link JackSpinner}
         */
        void onNothingSelected(JackSpinner spinner);
    }
}
