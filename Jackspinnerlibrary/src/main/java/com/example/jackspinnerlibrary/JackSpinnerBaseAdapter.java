...
public abstract  class JackSpinnerBaseAdapter<T> extends BaseAdapter {
    private final Context context;
    private int selectedIndex;
    private int textColor = Color.WHITE;

    public JackSpinnerBaseAdapter(Context context) {
    ...
    public JackSpinnerBaseAdapter<T> setTextColor(int textColor) {
