...
import zkrt.ui.d.UiDK;

/**
 * Created by jack_xie on 17-6-1.
 */

public abstract class UiBaseKView extends UiBaseHView {
    ...
    public UiBaseKView(Context var1, AttributeSet var2, int var3) {
    ...
    private void buildPathData() {
        ...
        try {
            ...
            DJILog.d("DULVelocityWidget", "Failed to add the cell paths");
        }

    }

    private UiDK getPathParser() {
        UiDD.a var1 = new UiDD.a();
