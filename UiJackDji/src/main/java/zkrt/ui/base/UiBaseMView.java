...
public abstract class UiBaseMView extends UiBaseOView{
    protected UiAA a;
    ...
    public UiBaseMView(Context var1) {
    ...
    private void a() {
        this.b = new ExpandableListView.OnGroupClickListener() {
            public boolean onGroupClick(ExpandableListView var1, View var2, int var3, long var4) {
                if(!UiBaseMView.this.a(var1, var2, var3, var4)) {
                    ;
                }
        ...
        this.c = new OnClickListener() {
            public void onClick(View var1) {
                UiBaseMView.this.a(var1.getTag());
            }
        };
        this.d = new UiAA.c() {
            public void a(UiCB var1, UiCA var2) {
                UiBaseMView.this.a(var1, var2);
            }
        ...
        this.a.a(this.c);
        this.a.a(this.d);
        this.k = this.findViewById(R.id.expandable_list_view_content);
        ...
        if(null != this.a && !this.a.a().isEmpty()) {
            ...
            for(int var6 = var4.size(); var5 < var6; ++var5) {
                ...
                if(var7.d == var2) {
                    ...
                    if(var7.f == 2) {
                        var7.e = var3;
                        (var7.uiCAArrayList.get(0)).b = var3;
                    } else {
                        var8 = 0;

                        for(var9 = var7.uiCAArrayList.size(); var8 < var9; ++var8) {
                            var10 = var7.uiCAArrayList.get(var8);
                            if(var10.b == var3) {
                                var10.d = true;
                                var7.c = var10.a;
                                var7.e = var3;
