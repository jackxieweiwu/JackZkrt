...
public class UiBaseMMarqueeTextView extends TextView {
    private static final String a = UiBaseMMarqueeTextView.class.getSimpleName();
    private UiBaseMMarqueeTextView.a b;
    private boolean c;
    private int d;

    public UiBaseMMarqueeTextView(Context var1) {
        this(var1, null, 0);
    }

    public UiBaseMMarqueeTextView(Context var1, AttributeSet var2) {
        this(var1, var2, 0);
    }

    public UiBaseMMarqueeTextView(Context var1, AttributeSet var2, int var3) {
        ...
        if(TextUtils.TruncateAt.MARQUEE == var4) {
            ...
            this.setSingleLine();
            this.b = new UiBaseMMarqueeTextView.a(this);
        } else {
        ...
        private a(TextView var1) {
            ...
            this.l = new Choreographer.FrameCallback() {
                public void doFrame(long var1) {
                    UiBaseMMarqueeTextView.a.this.a();
                }
            };
            this.m = new Choreographer.FrameCallback() {
                public void doFrame(long var1) {
                    UiBaseMMarqueeTextView.a.this.c = 2;
                    UiBaseMMarqueeTextView.a.this.j = SystemClock.uptimeMillis();
                    UiBaseMMarqueeTextView.a.this.a();
                }
            };
            this.n = new Choreographer.FrameCallback() {
                public void doFrame(long var1) {
                    if(UiBaseMMarqueeTextView.a.this.c == 2) {
                        if(UiBaseMMarqueeTextView.a.this.f >= 0) {
                            UiBaseMMarqueeTextView.a.this.f--;
                        }

                        UiBaseMMarqueeTextView.a.this.b(UiBaseMMarqueeTextView.a.this.f);
                    }
