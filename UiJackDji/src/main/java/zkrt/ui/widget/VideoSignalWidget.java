...
public class VideoSignalWidget extends UiBaseGViewDULFrameLayout {
    private ImageView hdSignal;
    private int signalValue;
    private int currentHDSignalResId;
    private UiCBA_M widgetAppearances;
    ...
    public void initView(Context var1, AttributeSet var2, int var3) {
        ...
        ImageView var4 = (ImageView)this.findViewById(R.id.imageview_rc_video_icon);
        this.hdSignal = (ImageView)this.findViewById(R.id.imageview_rc_video_signal);
