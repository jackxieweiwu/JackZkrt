...
public class GPSSignalWidget extends UiBaseGViewDULFrameLayout {
    ...
    public void initView(Context var1, AttributeSet var2, int var3) {
        ...
        this.gpsSignal = (ImageView)this.findViewById(R.id.imageview_gps_signal);
        this.satelliteNumber = (TextView)this.findViewById(R.id.textview_satellite_number);
        this.gpsType = (TextView)this.findViewById(R.id.textview_gps_type);
    }

    protected UiCAC getWidgetAppearances() {
        if(this.widgetAppearances == null) {
            this.widgetAppearances = new UiCBV();
        }
