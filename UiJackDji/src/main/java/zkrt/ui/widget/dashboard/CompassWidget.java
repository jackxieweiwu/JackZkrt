...
import zkrt.ui.c.b.UiCBL;
import zkrt.ui.c.b.UiCBM;
import zkrt.ui.d.UiDA;
import zkrt.ui.d.UiDE;
import zkrt.ui.d.UiDF;
import zkrt.ui.internal.compass.DULGimbalYawView;
import zkrt.ui.internal.compass.DULVisualCompassView;

/**
 * Created by jack_xie on 17-6-1.
 */

public class CompassWidget extends UiBaseGViewDULFrameLayout implements SensorEventListener {
        ...
        LocationListener var1 = new LocationListener() {
            public void onLocationChanged(Location var1) {
                if(var1 != null) {
                    ...
                    Observable.just(Boolean.valueOf(true)).observeOn(AndroidSchedulers.mainThread())
    ...
    public void transformValue(Object var1, DJIKey var2) {
        if(var2.equals(this.attitudePitchKey)) {
            ...
            if(var2.equals(this.aircraftLatitudeKey)) {
                ...
                this.gimbalHeading = ((Float)var1).floatValue();
            }
        }
        ...
        if(!var1.equals(this.homeLongitudeKey) && !var1.equals(this.homeLatitudeKey)) {
            if(var1.equals(this.rcGpsDataKey)) {
                ...
                if(var1.equals(this.attitudeYawKey)) {
                    ...
                    this.updateGimbalHeading(this.gimbalHeading);
    ...
    private void updateAircraftHeading() {
        ...
        if(this.gimbalYawImage != null) {
            this.gimbalYawImage.setRotation(this.gimbalHeading + this.aircraftHeading - this.phoneAzimuth);
        }
    ...
    private void updateSecondGPSLocation() {
        if(this.secondGPSImage != null) {
            if(this.centerType != 1) {
                this.secondGPSImage.setVisibility(VISIBLE);
                ...
                this.secondGPSImage.setVisibility(GONE);
            }
    ...
    private void calculateAircraftAngleAndDistanceFromCenterLocation() {
        float[] var1;
        if(this.centerType == 1) {
            if(UiDE.b(this.homeLatitude) && UiDE.a(this.homeLongitude)) {
                var1 = UiDE.a(this.homeLatitude, this.homeLongitude, this.aircraftLatitude, this.aircraftLongitude, true);
                this.aircraftAngle = var1[0];
                this.aircraftDistance = var1[1];
            }
        } else if(this.centerType == 0 && UiDE.b(this.rcOrMobileLatitude) && UiDE.a(this.rcOrMobileLongitude)) {
            var1 = UiDE.a(this.rcOrMobileLatitude, this.rcOrMobileLongitude, this.aircraftLatitude, this.aircraftLongitude, true);
            this.aircraftAngle = var1[0];
            this.aircraftDistance = var1[1];
        }
    ...
    private void calculateAngleAndDistanceBetweenRCAndHome() {
        if(this.centerType != 1) {
            float[] var1 = UiDE.a(this.rcOrMobileLatitude, this.rcOrMobileLongitude, this.homeLatitude, this.homeLongitude, false);
    ...
    private void updateCompassAnimateView(float var1) {
        if(this.compassAnimateView != null) {
            this.compassAnimateView.setVisibility(VISIBLE);
            this.innerStaticCycles.setVisibility(GONE);
