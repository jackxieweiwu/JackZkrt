...
public class RemainingFlightTimeWidget extends UiBaseGViewDULFrameLayout {
    ...
    private static final DJIKey LAND_IMMEDIATELY_BATTERY_THRESHOLD_KEY = FlightControllerKey.create("SeriousLowBatteryWarningThreshold");
    private static final DJIKey GO_HOME_BATTERY_THRESHOLD_KEY = FlightControllerKey.create("LowBatteryWarningThreshold");
