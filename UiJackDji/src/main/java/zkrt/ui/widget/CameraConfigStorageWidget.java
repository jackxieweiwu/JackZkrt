...
public class CameraConfigStorageWidget extends UiBaseGViewDULFrameLayout {
    ...
    private UiCBU widgetAppearances;
    ...
    public void initView(Context var1, AttributeSet var2, int var3) {
        ...
        this.cardInfoValue = (TextView)this.findViewById(R.id.TextView_card_info_value);
        this.imageFormatValue = (TextView)this.findViewById(R.id.TextView_image_format_value);
        this.cardInfoTitle = (TextView)this.findViewById(R.id.TextView_card_info_title);
    }
    ...
    private String convertResolutionAndFrameRateToString(SettingsDefinitions.VideoResolution var1, SettingsDefinitions.VideoFrameRate var2) {
        String var3 = UiDC.a(var1);
        String var4 = UiDC.a(var2);
        return var3 + "/" + var4;
    }
}
