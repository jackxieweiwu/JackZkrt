...
public class ReturnHomeWidget extends UiBaseEView {
    ...
    private void updateReturnHomeAlertDlg() {
        if(this.cancelGoingHomeResId == this.currentResId) {
            ...
            } else if(20 <= var9 && var9 <= 500 && var8 < (float)var9) {
                this.slideDialog.b(this.getContext().getString(R.string.left_menu_gohome_below_desc, new Object[]{Integer.valueOf(var9), Float.valueOf(UiDG.a((float)var9))}));
            } else {
                this.slideDialog.b(this.getContext().getString(R.string.left_menu_gohome_above_desc, new Object[]{Float.valueOf(var8), Float.valueOf(UiDG.a(var8))}));
            }
