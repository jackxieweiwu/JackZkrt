...
public class PictureVideoSwitch extends UiBaseGViewDULFrameLayout implements View.OnClickListener, DULSwitchButton.a {
    ...
    public void initView(Context var1, AttributeSet var2, int var3) {
        ...
        this.switchButton = (DULSwitchButton)this.findViewById(R.id.switch_button);
        this.photoIcon = (ImageView)this.findViewById(R.id.imageview_picture_icon);
        this.videoIcon = (ImageView)this.findViewById(R.id.imageview_video_icon);
