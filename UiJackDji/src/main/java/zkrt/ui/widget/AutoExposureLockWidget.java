...
public class AutoExposureLockWidget extends UiBaseGViewDULFrameLayout implements View.OnClickListener {
    ...
    public void initView(Context var1, AttributeSet var2, int var3) {
        ...
        ImageButton var4 = (ImageButton)this.findViewById(R.id.image_button_background);
        this.lockIcon = (ImageView)this.findViewById(R.id.imageview_lock);
