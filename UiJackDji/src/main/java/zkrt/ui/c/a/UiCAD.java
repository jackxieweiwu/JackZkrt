...
import antistatic.spinnerwheel.a.AnSpinner_B;
import zkrt.ui.R;
...
public class UiCAD<T> extends AnSpinner_B {
    private T[] f;
    ...
    public UiCAD(Context var1, T[] var2) {
        super(var1);
        this.f = var2;
        this.l = var2.length;
    ...
    protected CharSequence c(int var1) {
        if(var1 >= 0 && var1 < this.b()) {
            ...
            return (var2 instanceof CharSequence?(CharSequence)var2:var2.toString());
        } else {
            return null;
        }
    }
