...
public class DULStripeView extends View {
    ...
    public int getDesignedWidth() {
        ...
        return UiDI.a(this.getContext(), var2);
    }

    public int getDesignedHeight() {
        return UiDI.a(this.getContext(), 9.0F);
    }
    ...
    private Bitmap a(boolean var1, boolean var2) {
        Bitmap var3 = Bitmap.createBitmap(UiDI.a(this.getContext(), 4.0F), UiDI.a(this.getContext(), 9.0F), Bitmap.Config.ARGB_8888);
        var3.eraseColor(0);
        ...
        if(var1) {
            var4.drawCircle(UiDI.b(this.getContext(), 2.0F), UiDI.b(this.getContext(), 1.0F), UiDI.b(this.getContext(), 1.0F), var5);
            var4.drawRect(UiDI.b(this.getContext(), 1.0F), UiDI.b(this.getContext(), 3.0F), UiDI.b(this.getContext(), 3.0F), UiDI.b(this.getContext(), 9.0F), var5);
        } else {
            var4.drawRect(UiDI.b(this.getContext(), 1.0F), UiDI.b(this.getContext(), 4.5F), UiDI.b(this.getContext(), 3.0F), UiDI.b(this.getContext(), 9.0F), var5);
        }
