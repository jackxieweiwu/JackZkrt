...
import zkrt.ui.c.b.UiCBA_K;

/**
 * Created by jack_xie on 17-6-1.
 */

public class DULSwitchButton extends UiBaseCFramelayout implements View.OnTouchListener {
    private UiCAC a;
    private ImageView b;
    private boolean c;
    ...
    public void initView(Context var1, AttributeSet var2, int var3) {
        ...
        this.e = this.findViewById(R.id.layout_track);
        this.b = this.findViewById(R.id.imageview_left);
        this.a(var1, this.e);
