...
public class Inter_K extends UiBasePView {
    private DJIKey a;
    private int[] b;
    private int c;
    ...
    private void a(String var1, final int var2) {
        ...
        DInterNal var4 = new DInterNal(var3);
        var4.a(1);
    ...
    public void updateSelectedItem(View var1, int var2) {
        ...
        this.a(this.itemNameArray[var3.inta], var2);
    }
    ...
    private void interKA(int var1) {
        if(KeyManager.getInstance() != null) {
            ...
            var2.a(true);
            if(this.b != null) {
                final SettingsDefinitions.VideoStandard var3 = SettingsDefinitions.VideoStandard.find(var2.inta);
