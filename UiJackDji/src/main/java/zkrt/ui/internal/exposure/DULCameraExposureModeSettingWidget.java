...
import zkrt.ui.c.b.UiCBO;

/**
 * Created by root on 17-6-1.
 */

public class DULCameraExposureModeSettingWidget extends UiBaseGViewDULFrameLayout implements View.OnClickListener {
    ...
    public void initView(Context var1, AttributeSet var2, int var3) {
        ...
        this.c = (FrameLayout)this.findViewById(R.id.layout_camera_mode_p);
        this.e = (FrameLayout)this.findViewById(R.id.layout_camera_mode_s);
        this.f = (FrameLayout)this.findViewById(R.id.layout_camera_mode_a);
        this.g = (FrameLayout)this.findViewById(R.id.layout_camera_mode_m);
