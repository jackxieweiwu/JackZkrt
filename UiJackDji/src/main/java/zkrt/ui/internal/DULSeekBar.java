...
import zkrt.ui.c.b.UiCBA_H;

/**
 * Created by jack_xie on 17-6-1.
 */

public class DULSeekBar extends UiBaseCFramelayout implements View.OnTouchListener {
    private UiCAC a;
    private ImageView b;
    private ImageView c;
    private TextView d;
    ...
    public void initView(Context var1, AttributeSet var2, int var3) {
        ...
        this.b = (ImageView)this.findViewById(R.id.imageview_track);
        this.m = (ImageView)this.findViewById(R.id.imageview_thumb);
        this.n = (ImageView)this.findViewById(R.id.imageview_thumb_disable);
        this.d = (TextView)this.findViewById(R.id.textview_value);
    }
    ...
    public void a(boolean var1) {
        ...
        if(var1) {
            ...
            this.n.setVisibility(INVISIBLE);
