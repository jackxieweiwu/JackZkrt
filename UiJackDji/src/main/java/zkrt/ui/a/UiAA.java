...
import zkrt.ui.R;
import zkrt.ui.b.UiBB;
import zkrt.ui.b.UiBC;
import zkrt.ui.b.UiBD;
...
public class UiAA extends BaseExpandableListAdapter {
    ...
    public int getChildrenCount(int var1) {
        ...
        if(this.uiCBList != null && !this.uiCBList.isEmpty() && 0 <= var1 && var1 < this.uiCBList.size()) {
            UiCB var3 = this.uiCBList.get(var1);
    ...
    public View getGroupView(int var1, boolean var2, View var3, ViewGroup var4) {
        ...
        if(var5 instanceof UiCB) {
            uiB var6;
            if(null != var3 && var3.getTag() != null) {
                var6 = (uiB)var3.getTag();
            } else {
                var6 = new uiB();
                var3 = new UiBD(var4.getContext());
                var6.a = var3.findViewById(R.id.expendable_group_layout);
                var6.b = var3.findViewById(R.id.expandable_group_icon);
                var6.c = var3.findViewById(R.id.expandable_group_name);
                var6.d = var3.findViewById(R.id.expandable_group_value);
                var6.e = var3.findViewById(R.id.expandable_group_value_bg);
                var3.setTag(var6);
            }
    ...
    public View getChildView(int var1, int var2, boolean var3, View var4, ViewGroup var5) {
        ...
        if(var6 instanceof UiCB) {
            ...
            if(1 == var7.f) {
                uiA var8;
                if(null != var4) {
                    var8 = (uiA)var4.getTag();
                } else {
                    var8 = new uiA();
                    var4 = new UiBB(var5.getContext());
                    var8.view = var4.findViewById(R.id.expandable_child_layout);

                    for(int var9 = 0; var9 < b; ++var9) {
                        var8.textView[var9]= var4.findViewById(a[var9]);
                        var8.textView[var9].setOnClickListener(this.e);
                    }
                ...
                if(null == var4) {
                    ...
                    var10.b = var4.findViewById(R.id.expandable_child_sb);
                    var10.c = var4.findViewById(R.id.expandable_child_sb_tv);
                    var4.setTag(var10);
                    var10.b.setOnSeekBarChangeListener(this.g);
                } else {
                    var10 = (uiD)var4.getTag();
                }
    ...
    private final class uiD {
        ...
        public void a(UiCB var1, int var2, int var3) {
            ...
            UiCA var4 = var1.uiCAArrayList.get(var3);
            this.b.setTag(this);
    ...
    private static final class uiA {
        ...
        private uiA() {
            this.view = null;
            this.textView = new TextView[UiAA.b];
        }
        ...
        public void a(UiCB uiCB, int var2) {
            ...
            for(int var5 = 0; var5 < UiAA.b; ++var5) {
                this.textView[var5].setVisibility(View.INVISIBLE);
            }

            while(var2 + var3 < var4.size() && var3 < UiAA.b) {
                UiCA var6 = (UiCA)var4.get(var2 + var3);
                this.textView[var3].setTag(var6);
                this.textView[var3].setVisibility(View.VISIBLE);
                this.textView[var3].setSelected(var6.d);
                this.textView[var3].setText(var6.a);
                ++var3;
            }
