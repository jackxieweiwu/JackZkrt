...
class ExpandableGridView @JvmOverloads constructor(
    ...
    private var imageViewUp:ImageView? = null
    private var imageViewDown:ImageView? = null
    ...
    fun expandGridViewAtView(view: View, clickedView: View, numberw: Int, moudleNumber: Int) {
        ...
        clickedView.setOnTouchListener { v, event -> true }
         imageViewUp = ImageView(context)
         imageViewDown = ImageView(context)
        //if(moudleNumber == 3) {
        ...
        (imageViewUp as ImageView).setImageBitmap(bitmapUp)
        (imageViewUp as ImageView).setOnClickListener { collapseGridView() }
        (imageViewDown as ImageView).setImageBitmap(bitmapDown)
        (imageViewDown as ImageView).setOnClickListener { collapseGridView() }
    ...
    fun getImageViewUp(): ImageView? {
        return imageViewUp
    }
    fun getImageViewDown(): ImageView? {
